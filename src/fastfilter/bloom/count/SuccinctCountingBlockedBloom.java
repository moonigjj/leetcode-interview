 ...
 * @author tangyue
 * @version $Id: SuccinctCountingBlockedBloom.java, v 0.1 2020-01-14 10:54 tangyue Exp $$
 */
public class SuccinctCountingBlockedBloom implements Filter {
    ...
    SuccinctCountingBlockedBloom(int entryCount, int bitsPerKey, int k){
        ...
        this.realCounts = VERIFY_COUNTS ? new byte[arrayLength * 64] : null;
    }
    ...
    public long getBitCount() {
        return 64L * this.data.length + 64L * this.counts.length + 64L * this.overflow.length;
    }
